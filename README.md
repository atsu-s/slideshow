...
自身の機器に入っている画像データを10枚まで保存してまとめることができ、

SlideShow形式で閲覧することができます。また他の人の制作物も閲覧することができます。
...
できないといった事象に見舞われてしまうことが多々起きています。私はその課題を解決できないかと考え、
...
* 右上のResetボタンをクリックすることで初期状態に戻りやり直しができます。Saveボタンをクリックすることで作品の保存ができます
...
* 詳細画面では製作者、1枚目の画像、作品のタイトルを閲覧することができます。
...
* スライドショー画面は三次元的に表示され前後の画像が見切れるタイプのもので実装しました。画像の下部にナビを設置することにより
  ...
  視覚的に何枚目の画像なのか分かるようにしました。

* 本アプリはAWSのS3へ画像が保存されるようにしています。
...
* 公開画面では作成した作品の要素に加え、作品の説明文を記載することができ、コンセプトや作成時の心境を記載することができます
